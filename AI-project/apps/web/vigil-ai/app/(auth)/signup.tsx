      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.logoSubtext}>REGISTER TERMINAL COMMAND NODE</Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            <View style={[styles.inputWrap, nameFocused && styles.inputWrapFocused]}>
              <Text style={[styles.inputIcon, nameFocused && { color: '#00E5FF' }]}>👤</Text>
              <TextInput
                style={styles.input}
                placeholder="FULL CITIZEN NAME"
            ...
            <Pressable onPress={handleSignup} disabled={loading} style={styles.submitWrap}>
              <LinearGradient
                colors={['#00E5FF', '#7C3AED']}
                start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}
                style={styles.submitGrad}
              >
                <Text style={styles.submitText}>{loading ? 'PROVISIONING NODE CREDENTIALS...' : 'PROVISION COMMAND NODE'}</Text>
              </LinearGradient>
            </Pressable>
          </View>
          ...
          <View style={styles.orRow}>
            ...
            <Text style={styles.orText}>SECURE TACTICAL GRID</Text>
            <View style={styles.orLine} />
          </View>

          {/* Biometric alternate links */}
          <View style={styles.socialRow}>
            {['ENCRYPTED KEY', 'CREDENTIAL FILE'].map((label, i) => (
          ...
          <Pressable onPress={() => router.back()} style={styles.bottomLink}>
            <Text style={styles.bottomLinkText}>
              EXISTING NODE ACTIVE? <Text style={{ color: '#00E5FF', fontWeight: '900' }}>DECRYPT TERMINAL</Text>
            </Text>
          </Pressable>
